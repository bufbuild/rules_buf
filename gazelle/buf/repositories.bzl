"""Auto generated by `gazelle update-repos` command"""

load("@bazel_gazelle//:deps.bzl", "go_repository")

def gazelle_buf_dependencies():
    """Loads the `go_repository`'s required to build the buf extension for gazelle"""
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:gsWVkabKVp62fezc/Qal4N6oYT7eyFEU4Eb+SQz34rU=",
        version = "v0.0.0-20220113123053-0e2f864aac3a",
    )
    go_repository(
